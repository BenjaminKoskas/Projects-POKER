...
namespace Photon.Chat
{
    ...
    public class ChatParameterCode
    {
        ...
        /// <summary>(1) PlayerName of a single chat channel.</summary>
        ...
        /// <summary>(5) PlayerName of a the user who sent a chat message.</summary>
        public const byte Sender = 5;
        /// <summary>(6) Not used.</summary>
        public const byte ChannelUserCount = 6;
        /// <summary>(225) PlayerName of user to send a (private) message to.</summary><remarks>The code is used in LoadBalancing and copied over here.</remarks>

...
public static class PhotonNetwork
{
    ...
    /// <summary>PlayerName of the PhotonServerSettings file (used to load and by PhotonEditor to save new files).</summary>
    ...
    /// Null until set.
    ///
    /// Note that the PlayerName Server may assign another cluster, if the requested one is not configured or available.
    /// </remarks>
    ...
    /// 
    /// In all other cases, you should not define a cluster as this allows the PlayerName Server to distribute
    /// clients as needed. A random, load balanced cluster will be selected if available.
    ///
    /// The PlayerName Server has the final say to assign a cluster as available.
    ...
    ///
    /// To join a room from the lobby's listing, use RoomInfo.PlayerName as roomName here.
    ...
    /// </remarks>
    /// <param name="roomName">PlayerName of the room to join. Must be non null.</param>
    ...
    /// </remarks>
    /// <param name="prefabName">PlayerName of the prefab to instantiate.</param>
    ...
    /// PlayerName of the level to load. Make sure it's available to all clients in the same room.
    /// </param>

...
/// <remarks>Photon uses 3 different roles of servers: PlayerName Server, Master Server and Game Server.</remarks>
...
internal class NetworkingPeer : LoadBalancingPeer, IPhotonPeerListener
{
    ...
    /// <summary>PlayerName Server Host PlayerName for Photon Cloud. Without port and without any prefix.</summary>
    public const string NameServerHost = "ns.exitgames.com";

    /// <summary>PlayerName Server for HTTP connections to the Photon Cloud. Includes prefix and port.</summary>
    public const string NameServerHttp = "http://ns.exitgamescloud.com:80/photon/n";

    /// <summary>PlayerName Server port per protocol (the UDP port is different than TCP, etc).</summary>
    ...
    /// <summary>PlayerName Server Address for Photon Cloud (based on current protocol). You can use the default values and usually won't have to set this value.</summary>
    ...
    /// The Photon Cloud has a "PlayerName Server" which redirects clients to a specific Master Server (per Region and AppId).
    /// </remarks>
    ...
    /// <summary>The cluster name provided by the PlayerName Server.</summary>
    /// <remarks>
    /// The value is provided by the OpResponse for OpAuthenticate/OpAuthenticateOnce.
    /// Default: null. This value only ever updates from the PlayerName Server authenticate response.
    /// </remarks>
...
#region Operations and Connection Methods
    ...
    /// <summary>
    /// Connects you to a specific region's Master Server, using the PlayerName Server to find the IP.
    /// </summary>
    ...
    public void OnOperationResponse(OperationResponse operationResponse)
    {
        ...
        switch (operationResponse.OperationCode)
        {
            ...
            case OperationCode.GetRegions:
                ...
                {
                    Debug.LogError("The region arrays from PlayerName Server are not ok. Must be non-null and same length. " + (regions ==null)+ " " + (servers==null) + "\n"+operationResponse.ToStringFull());
                    break;
                }

...
using ExitGames.Client.Photon;
    ...
    {
        /// <summary>(255) PlayerName of a player/actor.</summary>
    ...
    public class ParameterCode
    {
        ...
        /// <summary>(209) Path of the WebRPC that got called. Also known as "WebRpc PlayerName". Type: string.</summary>
    ...
    public class RoomOptions
    {
        ...
        /// <remarks>
        /// PlayerName the custom room properties that should be available to clients that are in a lobby.
    ...
    {
        /// <summary>PlayerName of the lobby this game gets added to. Default: null, attached to default lobby. Lobbies are unique per lobbyName plus lobbyType, so the same name can be used when several types are existing.</summary>
        public string Name;

...
namespace Photon.Chat
{
    ...
    public class ChatClient : IPhotonPeerListener
    {
        ...
        /// <summary>The address of last connected PlayerName Server.</summary>
        ...
        /// </remarks>
        /// <param name="channelName">PlayerName of the channel to publish to.</param>
        ...
        /// </summary>
        /// <param name="target">PlayerName to send this message to.</param>
        ...
        /// </summary>
        /// <param name="channelName">PlayerName of the channel to get. For private channels, the channel-name is composed of both user's names.</param>
        ...
        /// </summary>
        /// <param name="channelName">PlayerName of the channel to get.</param>
        /// <param name="channel">Out parameter gives you the found channel, if any.</param>
        /// <returns>True if the channel was found.</returns>
        /// <remarks>Public channels exist only when subscribed to them.
        /// Private channels exist only when at least one message is exchanged with the target user privately.</remarks>
